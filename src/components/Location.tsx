      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
        <div className="flex flex-col gap-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h3 className="text-xl text-[#233539] mb-6 flex items-center gap-2">
                <FaMapMarkerAlt className="text-[#4A828F]" /> Studio Dentistico
              </h3>
              <p className="text-[#2E545D] my-3">Via G. Washington, 70, 20146 Milano MI</p>
            ...
            >
              ...
              {businessHours.map(({ day, hours }) => (
                <p key={day} className="text-[#2E545D] my-3">
          ...
          >
            ...
            <span className="text-sm">(120+ recensioni)</span>
          </motion.a>
        </div>
        ...
        >
          <div className="bg-white p-10 rounded-3xl shadow-lg shadow-blue-100/50 border border-gray-100">
            <div className="inline-flex items-center gap-2 bg-[#4A828F]/10 text-[#4A828F] px-6 py-3 rounded-full text-sm mb-6">
              <FaRegCalendarCheck /> Risposta entro 24h
            </div>
            
            <h2 className="text-3xl text-[#233539] mb-4 font-light">Prenota una Visita</h2>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <motion.button 
                ...
                className="p-4 bg-[#4A828F] text-white border-none rounded-xl text-base font-medium cursor-pointer transition-all duration-300 hover:bg-[#2E545D] disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-blue-200/50"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
