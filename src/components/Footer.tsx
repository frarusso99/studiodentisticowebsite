          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="font-manrope flex items-center gap-3 text-[#AFCDD5]/80">
            ...
            <div>
              ...
              <form onSubmit={handleSubscribe} className="space-y-3">
                ...
                <button
                  type="submit"
                  className="font-manrope font-medium w-full bg-[#4A828F] text-white py-3 rounded-lg hover:bg-[#2E545D] 
          ...
          <div className="border-t border-[#AFCDD5]/20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="font-manrope flex gap-6 text-sm">
                ...
                <a href="#" className="font-manrope text-[#AFCDD5]/60 hover:text-white transition-colors duration-300">
                  Cookie Policy
                </a>
              </div>
            </div>
