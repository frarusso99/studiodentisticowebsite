...
export const blogPosts: BlogPost[] = [
  {
    id: 1,
    category: 'Ortodonzia',
    title: 'Sorriso Perfetto con allineatori trasparenti',
    subtitle: 'Scopri come ottenere un sorriso perfetto in modo discreto e confortevole',
    image: '/studiodentisticowebsite/blogImages/allineatori.jpg',
    slug: 'sorriso-perfetto-allineatori-trasparenti',
    date: '23 Aprile 2025',
    readTime: '2 min',
    content: `
      <div class="mx-auto max-w-prose">
        <h2 class="text-2xl font-bold mb-4">Cosa sono gli allineatori trasparenti?</h2>
        <p class="mb-6">
          Gli allineatori trasparenti sono dispositivi ortodontici rimovibili realizzati su misura,
          progettati per allineare i denti in modo graduale e discreto. Costituiscono un'alternativa moderna
          ai tradizionali apparecchi metallici e si distinguono per la loro trasparenza e praticità.
        </p>
  
        <h2 class="text-2xl font-bold mb-4">Come funziona il trattamento?</h2>
        <p class="mb-6">
          Il percorso ortodontico con allineatori inizia con una valutazione approfondita della dentatura,
          solitamente accompagnata da una scansione digitale 3D. In base a questa analisi viene sviluppato
          un piano personalizzato che prevede una sequenza di mascherine da indossare per circa 1-2 settimane ciascuna,
          fino al raggiungimento del risultato desiderato.
        </p>
  
        <h2 class="text-2xl font-bold mb-4">Quali sono i principali vantaggi?</h2>
        <ul class="list-disc pl-6 mb-6">
          <li class="mb-2">Esteticamente discreti grazie alla trasparenza</li>
          <li class="mb-2">Facilmente rimovibili per mangiare e lavarsi i denti</li>
          <li class="mb-2">Maggiore comfort rispetto agli apparecchi fissi</li>
          <li class="mb-2">Favoriscono una migliore igiene orale quotidiana</li>
          <li>Piano di trattamento personalizzato e tracciabile digitalmente</li>
        </ul>
  
        <h2 class="text-2xl font-bold mb-4">Chi può beneficiarne?</h2>
        <p class="mb-6">
          Gli allineatori trasparenti sono adatti per adulti e adolescenti che desiderano correggere disallineamenti
          dentali come denti storti, spazi tra i denti, morso aperto o incrociato. Tuttavia, la loro efficacia dipende
          dalla complessità del caso: per questo è fondamentale una valutazione ortodontica prima di iniziare il trattamento.
        </p>
      </div>
    `
  },
...

  {
    ...
    "image": "/studiodentisticowebsite/blogImages/carie.jpg",
...

{
    ...
    "image": "/studiodentisticowebsite/blogImages/sbiancamento.jpg",
...

{
    ...
    "image": "/studiodentisticowebsite/blogImages/impianto.jpg",
...

{
    ...
    "image": "/studiodentisticowebsite/blogImages/gengivite.jpg",
